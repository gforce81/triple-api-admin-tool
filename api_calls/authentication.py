...
def store_config(environment):
    ...
    config['offer_display_activatedOffers'] = endpoints.endpoints['offer_display']['GET_activatedOffers']
    ...
    config['portfolio_listPublishers'] = endpoints.endpoints['portfolio_management']['GET_listPublishers']
